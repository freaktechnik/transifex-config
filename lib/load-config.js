 ...
 * @returns {ParsedConfig} Parsed contents of the config.
 * @async
 ...
 * @returns {ParsedConfig} Normalized RC.
 */
function normalizeRC(rc) {
    let value;
    for(const s of Object.keys(rc)) {
 ...
 * @returns {ParsedConfig} Parsed contents of the rc.
 * @async
